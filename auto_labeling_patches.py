...
DIR_S = {
    "label_dir": "./data/raw_qr_yolo_label",  # 圖片集的 yolo format.txt 根目錄
    "image_dir": "./data/raw_qr",  # 圖片集
    "save_dir": "./data/raw_qr_32x32_patches",  # 32x32 的儲存資料夾
    "predefined": "./data/predefined_classes.txt"  # class name 定義
}
...
if __name__ == "__main__":
    ...
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    for data_idx in range(21, len(qr_code_dataset)):
